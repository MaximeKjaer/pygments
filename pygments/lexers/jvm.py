...
class ScalaLexer(RegexLexer):
    ...
    tokens = {
        ...
        'declarations': [
            ...
            (u'\\b(given)\\b(\\s*)(%s|%s)?' % (idLower, backQuotedId), bygroups(Keyword, Text, Name.Class)),
        ],
        'inheritance': [
        ...
        'qualified-name': [
            (idUpper, Name.Class),
            (u'(%s)(\\.)' % anyId, bygroups(Name.Namespace, Punctuation)),
            (r'\.', Punctuation),
            (anyId, Name),
            (r'[^\S\n]+', Text),
        ],
...
class OldScalaLexer(RegexLexer):
    """
    For `Scala <http://www.scala-lang.org>`_ source code.
    """
    ...
    tokens = {
        ...
        'parameter-list': [
            ...
            (u'(implicit|using)(\\s+)(%s)(\\s*)(:)' % identifier,
             bygroups(Keyword, Text, Name, Text, Punctuation), 'type'),
